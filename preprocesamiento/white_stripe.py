...
def White_Stripe(img):
    ...
    nueva_img_data = img_original / ws_i
    ...
    if file_path:
        ...
        img_nifti = nib.Nifti1Image(nueva_img_data, img.affine)  # Utilizamos np.eye(4) para la matriz de transformación (espacio físico)
